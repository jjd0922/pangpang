...
b.aanFeatures.i&&"api"!==a.select.style()){var c=a.rows({selected:!0}).flatten().length,d=a.columns({selected:!0}).flatten().length,e=a.cells({selected:!0}).flatten().length,l=function(b,c,d){b.append(f('<span class="select-item"/>').append(a.i18n("select."+c+"s",{_:"―　%d개의 "+c+"이 선택되었습니다.",0:"",1:"―　1개의 "+c+"이 선택되었습니다."},d)))};f.each(b.aanFeatures.i,function(b,a){a=f(a);b=f('<span class="select-info"/>');l(b,"행",c);l(b,"열",d);l(b,"셀",e);var g=a.children("span.select-info");g.length&&g.remove();
